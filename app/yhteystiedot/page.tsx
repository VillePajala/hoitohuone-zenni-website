          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <a
                ...
                className="inline-flex items-center gap-3 px-4 py-2 text-gray-800 bg-white border border-gray-200 rounded-full shadow-sm hover:border-gray-300 hover:shadow transition"
              >
                ...
                <span className="font-medium">Seuraa Facebookissa</span>
              </a>
            </div>
            ...
            <div>
              ...
              <a
                href="https://instagram.com/hoitohuonezenni"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 px-4 py-2 text-gray-800 bg-white border border-gray-200 rounded-full shadow-sm hover:border-gray-300 hover:shadow transition"
              >
                ...
                <span className="font-medium">Seuraa Instagramissa</span>
              </a>
            </div>
          </div>
        </div>
